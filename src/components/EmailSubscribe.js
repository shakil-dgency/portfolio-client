			...
			{component !== "footer" ? (
				<div className={``}>
					<div className="relative flex max-w-[330px] sm:max-w-[250px] mt-10">
						...
						/>
						<button onClick={handleEmailPost} className=" bg-[#222222] text-white px-[15px] rounded-r-[5px] text-[13px]  ml-[-10px] ">Subscribe</button>
					</div>
				...
				<div className="w-full  max-w-[420px] md:flex-1">
					<div className="relative flex  ">
						...
						/>
						<button onClick={handleEmailPost} className=" bg-[#222222] text-white px-3 sm:px-[25px] rounded-r-[5px] text-[13px]  ml-[-10px] ">Subscribe</button>
					</div>
