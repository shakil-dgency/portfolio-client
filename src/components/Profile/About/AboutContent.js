			...
			<div className="-mt-3 flex gap-6">
				<div className="text-[var(--para-text)] text-[16px] font-[400] max-w-[695px] lg:max-w-[495px] ">
					...
					<div className="mt-10 relative block lg:hidden">
						<Image src={hamid} height={300} width={500} alt="" className=" lg:h-[580px] w-[inherit] " />
						<div className="h-[35px] w-full bg-gradient-to-t from-[#F6F7F9] to-transparent absolute bottom-0 "></div>
					</div>
				...
				<div className="flex- -mt-[90px] relative hidden lg:block">
					<Image src={hamid} height={300} width={400} alt="" className=" h-[580px] w-[inherit] " />
					<div className="h-[35px] w-full bg-gradient-to-t from-[#F6F7F9] to-transparent absolute bottom-0 "></div>
				</div>
			</div>
		</div>
